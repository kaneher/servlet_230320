...
<section class="content1 border border-success d-flex align-items-start p-3 mb-4">
	<img src="<%= artistInfo.get("photo") %>" alt="IU" width="200" height="200" class="mr-4">
	<div>
		<h3 class="font-weight-bold mb-3"><%= artistInfo.get("name") %></h3>
		<div class="font-weight-bold"><%= artistInfo.get("agency") %></div>
		<div class="font-weight-bold"><%= artistInfo.get("debut") %> 데뷔</div>
	</div>
</section>
	...
	<table class="table text-center">
		...
		%>
			<tr class="row">
				...
				<td class="col-4"><a href="template2.jsp?id=<%= maps.get("id") %>" class="cTitle"><%= maps.get("title") %></a></td>
